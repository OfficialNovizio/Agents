...
def run_all_tests() -> int:
    ...
    check("summary: pharma — should be attractive",
          "ATTRACTIVE" in ph_summary["verdict"], True)
    ...
    check("strategy: Apple = Differentiation", ap["strategy"], "Differentiation")
    ...
    check("attractiveness: hot industry score > 7", attract["composite_score"] >= 7.0, True)
    ...
    check_raises("mobility_barriers: bad score",
                 mobility_barriers, groups, {("A", "B"): 6})
    ...
    check("integration: soft drinks → differentiation", sd_strategy["strategy"], "Differentiation")

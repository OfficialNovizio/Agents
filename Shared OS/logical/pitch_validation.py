...
def run_all_tests() -> int:
    ...
    check("consistency: arr flagged", disc[0]["metric"], "arr")
    ...
    check("audit_clean: overall pass", audit_clean["overall_pass"], True)
    check("audit_clean: 5 checks run", len(audit_clean["checks_run"]) >= 5, True)
